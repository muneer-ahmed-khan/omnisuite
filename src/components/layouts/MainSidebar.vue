...
const stateStoreInstance = useStateStore()
</script>
            ...
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/" class="sidebar-sub-menu-link"> Ecommerce </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
        ...
        <li class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/emails" class="sidebar-sub-menu-link"> Inbox </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/orders" class="sidebar-sub-menu-link"> Orders </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/checkout" class="sidebar-sub-menu-link"> Checkout </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/sellers" class="sidebar-sub-menu-link"> Sellers </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/refund" class="sidebar-sub-menu-link"> Refund </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                  <router-link to="/invoice" class="sidebar-sub-menu-link"> Invoice </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/contacts" class="sidebar-sub-menu-link"> Contacts </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
        ...
        <li class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/login" class="sidebar-sub-menu-link"> Login </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                  <router-link to="/register" class="sidebar-sub-menu-link"> Register </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/add-user" class="sidebar-sub-menu-link"> Add User </router-link>
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/forms-range" class="sidebar-sub-menu-link"> Range </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                  <router-link to="/forms-input-group" class="sidebar-sub-menu-link"
        ...
        <li class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/charts" class="sidebar-sub-menu-link"> Charts </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
        ...
        <li class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-tree" class="sidebar-sub-menu-link"> Tree </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-alerts" class="sidebar-sub-menu-link"> Alerts </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-badges" class="sidebar-sub-menu-link"> Badges </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-modal" class="sidebar-sub-menu-link"> Modal </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-ratio" class="sidebar-sub-menu-link"> Ratio </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-stacks" class="sidebar-sub-menu-link"> Stacks </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-tables" class="sidebar-sub-menu-link"> Tables </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-toasts" class="sidebar-sub-menu-link"> Toasts </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-colors" class="sidebar-sub-menu-link"> Colors </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-flex" class="sidebar-sub-menu-link"> Flex </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-float" class="sidebar-sub-menu-link"> Float </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-grid" class="sidebar-sub-menu-link"> Grid </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-sizing" class="sidebar-sub-menu-link"> Sizing </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/ui-text" class="sidebar-sub-menu-link"> Text </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
        ...
        <li class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/cards" class="sidebar-sub-menu-link"> Cards </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                  <router-link to="/charts" class="sidebar-sub-menu-link"> Charts </router-link>
                </li>
        ...
        <li class="sidebar-nav-item accordion-item bg-transparent border-0 rounded-0">
          ...
          >
            <div class="accordion-body">
              <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                <li class="sidebar-sub-menu-item">
                  <router-link to="/gallery" class="sidebar-sub-menu-link"> Gallery </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                ...
                <li class="sidebar-sub-menu-item">
                  <router-link to="/profile" class="sidebar-sub-menu-link"> Profile </router-link>
                </li>
                <li class="sidebar-sub-menu-item">
                                ...
                                >
                                  ...
                                  >
                                    <div class="accordion-body">
                                      <ul class="sidebar-sub-menu ps-0 mb-0 list-unstyled">
                                        <li class="sidebar-sub-menu-item">
                                          <a href="#" class="sidebar-sub-menu-link"> One </a>
                                        </li>
                                        <li class="sidebar-sub-menu-item">
                                          <a href="#" class="sidebar-sub-menu-link"> Two </a>
                                        </li>
                                      </ul>
                                    </div>
                                  </div>

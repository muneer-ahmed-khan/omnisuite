...
import LightDarkSwtichBtn from '@/components/layouts/LightDarkSwitchBtn.vue'
            ...
            <div class="dropdown-menu rounded-0 bg-white border-0 start-auto end-0">
              <div class="title d-flex align-items-center justify-content-between">
                <span class="text-black fw-bold">
                  Messages <span class="text-muted">(03)</span>
                </span>
                <router-link
                  to="/chat"
              ...
              <ul class="ps-0 mb-0 list-unstyled dropdown-body">
                <li class="position-relative">
                  ...
                  <span class="d-block fw-semibold text-black-emphasis">
                    Jacob Linowiski
                    <span class="ms-5 text-muted fw-normal">35 mins ago</span>
                  </span>
                ...
                <li class="text-muted position-relative">
                  ...
                  <span class="d-block fw-semibold text-black-emphasis">
                    Angela Carter
                    <span class="ms-5 text-muted fw-normal">1 day ago</span>
                  </span>
                ...
                <li class="text-muted position-relative">
                  ...
                  <span class="d-block fw-semibold text-black-emphasis">
                    Brad Traversy
                    <span class="ms-5 text-muted fw-normal">2 days ago</span>
                  </span>
                  Hey Victor! Could you please...
                  <router-link
                    to="/chat"
            ...
            <div class="dropdown-menu rounded-0 bg-white border-0 start-auto end-0">
              ...
              <ul class="ps-0 mb-0 list-unstyled dropdown-body">
                ...
                <li class="text-muted position-relative">
                  ...
                  <span class="d-block text-black-emphasis">
                    <strong class="fw-semibold">A new user</strong> added in Adlash
                  </span>
                  3 hrs ago
                  <router-link
                    to="/notifications"

 ...
 * -----------------------------------------------------------------------------
 * Displays a table of recent lead entries including names, emails, and statuses.
 *
 * @usage
 * <RecentLeads />
 */

import { recentLeads } from './data/recent-leads.data'
import type { RecentLead } from './types/recent-leads.types'

const leads: RecentLead[] = recentLeads

defineOptions({ name: 'RecentLeads' })
</script>
        ...
        <table class="table text-nowrap align-middle mb-0">
          ...
          <tbody>
            <tr v-for="lead in leads" :key="lead.id">
              ...
              <td class="shadow-none lh-1 fw-medium text-primary">{{ lead.email }}</td>
              <td class="shadow-none lh-1 fw-medium">
                <span :class="['badge', lead.class]">{{ lead.status }}</span>
              </td>
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                        <i class="flaticon-view lh-1 me-8 position-relative top-1"></i> View
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                        <i class="flaticon-pen lh-1 me-8 position-relative top-1"></i> Edit
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
